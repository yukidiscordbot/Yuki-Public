...
const quiz = [
  ...
  { q: "What programming language am I made in?", a: ["discord.js",] },
  ...
  { q: "Which day discord got released?", a: ["2015", "May 13, 2015", "may 13"] }
];
const options = {
  max: 1,
  time: 30050,
...
module.exports = class {
    constructor() {
        this.help = {
            category: "Fun",
            description: "You need to answer that question!"
        };
    }
  ...
  console.log(xpAdd);
    return message.channel.send({embed: new Discord.RichEmbed()
                                 .setAuthor(`GG ${winnerMessage.author.tag}!`, winnerMessage.author.displayAvatarURL)
                                 .setTitle(`Correct Answer: \`${winnerMessage.content}\` on \`${item.q}\``)
                                 .addField(`${winnerMessage.author.tag} wins`, `1 XP!`)
                                 .setColor("GREEN")
                                })
  } catch (_) {
                                                    message.react("👎");
    return message.channel.send({embed: new Discord.RichEmbed()
                                 ...
                                 .setTitle(`Correct Answer(s): \`${item.a}\` for \`${item.q}\``)
                                 .setColor("RED")
                                })
  }
}
