...
module.exports = class {
  ...
  //!addrole @andrew Dog Person
    ...
    if(!role) return message.channel.send("<:error:543851339713609745> Type the role you wanna remove from a member.") 
    ...
    if(!message.guild.me.hasPermission(["MANAGE_ROLES"])) return message.channel.send("<:error:543851339713609745> You need to add me a **Manage Role (MANAGE_ROLES)** permission.")
        ...
        message.channel.send(`<:success:543851339696963584> **${role.name}** (**${role.id}**) role has been removed from **${rMember.displayName}** (**${rMember.id}**).`)
    }
    }